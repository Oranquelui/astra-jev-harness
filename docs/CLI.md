...
1. `plan --repo ROOT --task-file TASK --out PLAN`: snapshot eligible tracked files locally, outside the source repository. Review `PLAN.md` and preserve existing changes.
